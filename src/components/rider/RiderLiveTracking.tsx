...
const RiderLiveTracking: FC<{
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <TouchableOpacity style={mapStyles.gpsButton} onPress={() => {}}>
        <CustomText fontFamily="SemiBold" fontSize={RFValue(12)}>
          Open Live Gps
        </CustomText>
        <FontAwesome6 style={mapStyles.gpsButton} onPress={fitToMarkers} />
      </TouchableOpacity>
